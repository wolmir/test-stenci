      ...
      <div class="column col-6">
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <input class="form-input" type="text" id="input-email" placeholder="Email" v-model="pessoa.email" />
          </div>

          <div class="form-group">
            <label class="form-label" for="input-telefone">Telefone</label>
            <input class="form-input" type="text" id="input-telefone" placeholder="Telefone" v-model="pessoa.telefone" />
          </div>

          <div class="form-group">
            <label class="form-label" for="input-celular">Celular</label>
            <input class="form-input" type="text" id="input-celular" placeholder="Celular" v-model="pessoa.celular" />
          </div>
          ...
          <div class="my-3" v-for="(item, index) in pessoa.enderecos" v-bind:key="index">
            <div class="form-group">
              ...
              <input class="form-input" type="text" placeholder="Endereço" v-model="pessoa.enderecos[index].endereco" />
            </div>

            <div class="form-group">
              <label class="form-label">Número</label>
              <input class="form-input" type="text" placeholder="Número" v-model="pessoa.enderecos[index].numero" />
            </div>

            <div class="form-group">
              <label class="form-label">Complemento</label>
              <input class="form-input" type="text" placeholder="Complemento" v-model="pessoa.enderecos[index].complemento" />
            </div>

            <div class="form-group">
              <label class="form-label">Bairro</label>
              <input class="form-input" type="text" placeholder="Bairro" v-model="pessoa.enderecos[index].bairro" />
            </div>

            <div class="form-group">
              <label class="form-label">Cidade</label>
              <input class="form-input" type="text" placeholder="Cidade" v-model="pessoa.enderecos[index].cidade" />
            </div>

            <div class="form-group">
              <label class="form-label">Estado</label>
              <input class="form-input" type="text" placeholder="Estado" v-model="pessoa.enderecos[index].estado" />
            </div>

            <div class="form-group">
              <label class="form-label">CEP</label>
              <input class="form-input" type="text" placeholder="CEP" v-model="pessoa.enderecos[index].cep" />
            </div>

          </div>
          <button class="btn my-2" v-on:click="addEndereco">Adicionar Endereço</button>
          <button class="btn btn-primary my-2" v-on:click="cadastrar">Cadastrar</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    cadastrar () {
      ...
      if (!this.hasError()) {
        const queryFisica = gql`mutation CriarPessoaMutation(
          $nome: String,
          $tipo: Tipo,
          $cpf: String,
          $sexo: String,
        ...
        const queryJuridica = gql`mutation CriarPessoaMutation(
          $nome: String,
          $tipo: Tipo,
          $razaoSocial: String,
          $cnpj: String,
        ...
        const variablesFisica = _.pick(this.pessoa, ['cpf', 'sexo', 'dataNasc'])

        const variablesJuridica = _.pick(this.pessoa, ['cnpj', 'razaoSocial'])
